...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js??ref--2-2!./about.css", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js??ref--2-2!./about.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js??ref--2-2!./contact.css", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js!./../../node_modules/postcss-loader/index.js??ref--2-2!./contact.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
module.exports = __webpack_require__.p + "fca984d5b46cef5198f0290edb3854e6.svg";
...
module.exports = __webpack_require__.p + "e2741d9c6edbf0c1ff5c8e54e7946dc3.svg";
...
module.exports = __webpack_require__.p + "10f654186df976db0772e0d7496c4b72.svg";

/***/ }),
/* 30 */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "deeee71810d0f3b5af48c6801d11699a.svg";
...
(function () {
  ...
  var navList = navBar.querySelectorAll('.nav-list > li');
  ...
  navList.forEach(function (item) {
    return item.addEventListener('click', slowScroll);
  });
  ...
  function slowScroll() {
    var scrollId = this.dataset.to;
    var to = document.getElementById(scrollId).getBoundingClientRect().top;
    var size = void 0;
    ...
    switch (scrollId) {
      case 'work':
        size = 7;break;
      case 'about':
        size = 11, to = to - 15;break;
      case 'contact':
        size = 15;to = document.body.scrollHeight - document.body.clientHeight - 5;break;
    }
